    ...
    <div class="content">
        <div class="login_panel">
            ...
            <form action="" method="POST" id="member">
                ...
                <div class="buttons">
                    <div>
                        <button class="grey" name="login">Se connecter</button>
                    </div>
                </div>
        </div>
        </form>
        ...
        <div class="register_account">
            ...
            <form action="" method="POST">
                ...
                <div class="search">
                    <div>
                        <button class="grey" name="register">S'inscrire</button>
                    </div>
                </div>
                <p class="terms">En cliquant sur 'S'inscrire', vous acceptez les <a href="CGU.php">Conditions générales
                        d'utilisation</a>.</p>
                <div class="clear"></div>
            </form>
        </div>
