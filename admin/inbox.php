                    ...
                    while ($rows = $getAllorder->fetch_assoc()) {
                        ...
                        <tr class="odd gradeX">
                            ...
                            if ($rows['status'] == 0) {
                                ?>
                                <td>
                                    <a href="?shiftid=<?php echo $rows['csId']; ?>&price=<?php echo $rows['price']; ?>&time=<?php echo $rows['Date']; ?>">Shift</a>
                                </td>
                            ...
                            <?php } else { ?>
                                ...
                                <td>
                                    <a href="?confirmedid=<?php echo $rows['csId']; ?>&price=<?php echo $rows['price']; ?>&time=<?php echo $rows['Date']; ?>">Remove</a>
                                </td>
                            <?php } ?>
                        </tr>
