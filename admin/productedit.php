                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <table class="form">
                        ...
                        if ($pdinfo) {
                            while ($pdresult = $pdinfo->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="pname" value="<?php echo $pdresult['productName']; ?>"
                                               class="medium"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="tinymce"
                                                  name="pdescription"><?php echo $pdresult['body']; ?></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" name="p_price" value="<?php echo $pdresult['price']; ?>"
                                               class="medium"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img width="100px" height="80px;" src="<?php echo $pdresult['image']; ?>"
                                             alt="">
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <input type="submit" name="submit" Value="Sauvegarder Produit"/>
                            </td>
                        </tr>
                    </table>
                </form>
